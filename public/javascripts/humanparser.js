// Vendored from humanparser — https://github.com/chovy/humanparser (MIT).
// Source: index.js of upstream master @ 2026-05-15. This project has no
// client-side bundler, so the npm package isn't directly usable; the only
// modification is the upstream line `const parser = module.exports = {}`
// replaced with the UMD shim around the IIFE below. To update, re-fetch
// upstream and keep this wrapper in place.
//
// Exposed as window.RAD.humanparser in the browser and as module.exports
// under node (the test runner consumes the latter via test/citations.test.js).
